 ...
 * main.c
 * Author: Carl Larsson
 * Description: lab 5 3.2, priority inversion
 * Date: 2023-09-26
 * ----------------------------------------------------------------------------
 */
...
void task1(void *temp)
{
    ...
    // ms to wait, 11s
    const TickType_t wait_time = pdMS_TO_TICKS(11000);
    int start_time, stop_time, run_time, before_sem, after_sem, sem_wait;
    //-----------------------------------------------------------------------------
...
void task2(void *temp)
{
    ...
    xLastWakeTime = xTaskGetTickCount();
    // ms to wait, 13s
    const TickType_t wait_time = pdMS_TO_TICKS(13000);
...
void task3(void *temp)
{
    ...
    xLastWakeTime = xTaskGetTickCount();
    // ms to wait, 6s
    const TickType_t wait_time = pdMS_TO_TICKS(6000);
    int start_time, stop_time, run_time, before_sem, after_sem, sem_wait;
    //-----------------------------------------------------------------------------
